...
\include{1-plantar-cara/01-manifesto.md}
\include{1-plantar-cara/02-about-the-party.md}
\include{1-plantar-cara/03-institutional-struggle.md}
\include{1-plantar-cara/04-our-intuitions.md}
\include{1-plantar-cara/05-know-to-do.md}
\include{1-plantar-cara/06-lefts-right.md}
\include{1-plantar-cara/07-some-warnings.md}
