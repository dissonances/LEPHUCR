...
\begin{figure}[htbp]
	\centering	\includegraphics[width=.9\linewidth]{spheres-practices.png}
...
\begin{figure}[htbp]
	\centering	\includegraphics[width=.9\linewidth]{caltra.jpg}
...
\begin{figure}[htbp]
	\centering	\includegraphics[width=.7\linewidth]{nudge.jpg}
